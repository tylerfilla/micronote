...
public class NoteEditorOld extends WebView {
    ...
    public NoteEditorOld(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initializeWebView() {
        ...
        this.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                if (!NoteEditorOld.this.initialized && NoteEditorOld.this.onInitializedListener != null) {
                    // Set initialized flag
                    NoteEditorOld.this.initialized = true;
                    
                    // Callback
                    NoteEditorOld.this.onInitializedListener.onInitialized();
                }
            }
        ...
        this.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
                ...
                NoteEditorOld.this.onReceivePageMessage(message);
        ...
        this.loadUrl(NoteEditorOld.ASSET_PATH_EDITOR_HTML_INDEX);
